...
//     const requestBody = {
//       image: imageBase64,            // store private only then
//       title: title,                   // based on ai settings
//       context: '', 
//       keywords: Array.isArray(keywords) ? keywords : (keywords ? keywords.split(',').map(k => k.trim()) : []), // remove
...
//       image_id: imageId || '',
//       source: API_CONFIG.defaultSettings.source, // shopify_app
//       site_id: '',                               // remove
//       language: language, // Use the passed language parameter
//       model_type: API_CONFIG.defaultSettings.model_type,  //gemini
//       product_name: product_name,
//       alt_gen_settings_shp: userDetails || {}
//     };
//       // product ke niche ek aur filter draft or published 
